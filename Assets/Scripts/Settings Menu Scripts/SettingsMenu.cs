...
public class SettingsMenu : MonoBehaviour
{
    ...
    public ControlScript controlScript; // hud
    ...
    private void Start()
    {
        ...
        FindAnyObjectByType<AudioManager>()?.SetMasterVolume((FloatSetting.Value - FloatSetting.min) / (FloatSetting.max - FloatSetting.min));
