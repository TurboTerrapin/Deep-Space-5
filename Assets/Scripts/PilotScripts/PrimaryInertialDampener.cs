/*
    PrimaryInertialDampener.cs
    - Meant to enable/disable primary inertial dampener
    - Does nothing
...
public class PrimaryInertialDampener : InertialDampener, IControllable
{
    private string CONTROL_NAME = "PRIMARY INERTIAL DAMPENER";
