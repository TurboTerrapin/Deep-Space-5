...
public class DestructSequence : NetworkBehaviour, IControllable
{
    //CLASS CONSTANTS
    private static float PUSH_TIME = 0.5f;
    private static float COOLDOWN_TIME = 2.0f;

    private string CONTROL_NAME = "SELF-DESTRUCT SEQUENCE";
    private List<string> CONTROL_DESCS = new List<string> { "INITIATE", "ABORT" };
    private List<int> CONTROL_INDEXES = new List<int>() { 6, 12 };
